...
- (UIView *)view
{
    ...
    _noneZeroRullerView = [[RCTScrollRuler alloc]initWithFrame:CGRectMake(10, 0, ScreenWidth-20, rullerHeight) theMinValue:0 theMaxValue:0 exponent:0 defaultValue:5 theStep:1.0 theNum:10 theUnit:@"" isTime:false markerColor:@"#ff8d2a" markerTextColor:@"#ffffff" accessbilityText:@"" fontFamily:@"DRPublik-SemiBold"];
